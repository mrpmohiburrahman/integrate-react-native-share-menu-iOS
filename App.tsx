...
const App: () => React$Node = () => {
  ...
  const handleShare = useCallback((item?: SharedItem) => {
    ...
    console.log(`🚀 ~ file: App.tsx:22 ~ handleShare ~ extraData`, extraData);
    console.log(`🚀 ~ file: App.tsx:22 ~ handleShare ~ data`, data);
    console.log(`🚀 ~ file: App.tsx:22 ~ handleShare ~ mimeType`, mimeType);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.instructions}>check the console log for data</Text>
